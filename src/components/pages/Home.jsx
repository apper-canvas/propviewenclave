...
if (filters.amenities.length > 0) {
    ...
    filtered.sort((a, b) => {
      switch (currentSort) {
case 'price-asc':
          return a.price_c - b.price_c;
        case 'price-desc':
          return b.price_c - a.price_c;
        case 'newest':
          return new Date(b.listingDate_c) - new Date(a.listingDate_c);
        case 'oldest':
          return new Date(a.listingDate_c) - new Date(b.listingDate_c);
        case 'bedrooms-desc':
          return b.bedrooms_c - a.bedrooms_c;
        case 'sqft-desc':
          return b.squareFeet_c - a.squareFeet_c;
        default:
          return 0;
      }
    });
